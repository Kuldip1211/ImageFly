  ...
  return (
    ...
    >
      ...
      className="text-center max-w-xl mx-auto mt-5">
       Unleash your creativity with Ai. Turn your imagination into visual art in secound- just type, and watch the magic happen
      </motion.p>
      ...
      <motion.p
       ...
       className="mt-2 text-neutral-600">Ganrate image from imagify</motion.p>
    </motion.div>
  )
}
